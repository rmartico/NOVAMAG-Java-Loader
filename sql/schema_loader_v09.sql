/*
Confidential attribute within items table is added
PNG file type is added to file_types table
lattice_system lenght grows from 3 to 4:	 	varchar(4) because of 'TRIC'
*/
